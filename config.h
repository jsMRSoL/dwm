...
static const char *passmenu2[] = {"passmenu2", "gtk", NULL };
static const char *displayswitchcmd[] = { "displayswitcher", NULL };
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,        XK_p,      spawn,       {.v = passmenu2 } },
	{ MODKEY|ShiftMask,        0xffc1,      spawn,       {.v = displayswitchcmd } },
